...
?>
	...
	<div class="app-card app-card-orders-table shadow-sm mb-5">
	    ...
	    <div class="app-card-body p-3">
	    	...
	    	<form class="forms-sample" action="subject_update.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?=$subcategory['id']?>">

                <div class="row mb-3">
				    <label for="inputCategory" class="col-sm-2 col-form-label">Subject:</label>
				    <div class="col-sm-10">
				      	<input type="text" class="form-control" id="inputCategory" name="name" value="<?=$subcategory['name']?>" required>
				    </div>
				</div>
